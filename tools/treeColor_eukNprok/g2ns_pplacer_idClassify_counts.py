...
if args.treecolor_csv != None:
	...
	TCInfoPath = "/blue/b.durham/rebeccakey/4_boysenTrees/tools/treecolor_files_prok/treecolors_w_proks2.csv"
...
for line in in_csv:
	...
	origin = line_elts[0]
#	sample_name = origin.split("X.")[1]
	sample_name = origin.split(".aln")[0]
	sample_name = sample_name.split("G2NS.")[1]
